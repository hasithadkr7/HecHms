...
def update_distributed_model_script(model_dir, model_name):
...
def update_distributed_model_configs(control_file, run_file, gage_file, rainfall_file, init_state=False):
    try:
